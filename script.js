...
function draw() {
    // KANSERİ ÖNLEYEN KOD BURADA: Her karede blendMode'u sıfırlıyoruz ki ekran kararmasın!
    blendMode(BLEND); 
    ...
    if (appState === "STORY_READY" || appState === "STORY_MAHCUP" || appState === "STORY_GERGIN" || appState === "HAYAL_KIRIKLIGI") {
        ...
        // İŞTE KUTUYU SİLEN VE RENKLERİ DÜZELTEN KISIM:
        blendMode(MULTIPLY); // Videonun beyaz arka planını siler.
        drawingContext.filter = 'blur(0.5px)'; // INVERT (ters çevirme) SİLİNDİ!
