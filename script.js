...
function draw() {
    // İŞTE KUTUYU SİLECEK OLAN O BASİT ÇÖZÜM: Arka planı tam beyaz yaptık! CSS ters çevirince videonun arkasıyla aynı siyah olacak.
    ...
    if (appState === "STORY_READY" || appState === "STORY_MAHCUP" || appState === "STORY_GERGIN" || appState === "HAYAL_KIRIKLIGI") {
        ...
        // SAFARİ'Yİ ÇÖKERTEN TÜM FİLTRELERİ SİLDİM!
        // Sadece opaklık verip çizdiriyoruz. CSS zaten geri kalan rengi halledecek!
