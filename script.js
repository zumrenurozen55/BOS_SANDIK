...
function preload() {
    // SENİN GITHUB'DAKİ GERÇEK RESİM DOSYALARIN (BİREBİR AYNI)
...
function setup() {
    ...
    // BENİM KAFAMA GÖRE DEĞİŞTİRDİĞİM YERİ DÜZELTTİM! SENDEKİ GİBİ .webm YAPTIM
...
function draw() {
    ...
    if (appState === "STORY_READY" || appState === "STORY_MAHCUP" || appState === "STORY_GERGIN" || appState === "HAYAL_KIRIKLIGI") {
        ...
        drawingContext.filter = 'blur(0.5px) invert(1)'; 
        ...
        if (currentAsset) {
            ...
            image(currentAsset, width/2 + driftX, drawY + driftY, drawW, drawH);
        }
        pop();
    }
}
